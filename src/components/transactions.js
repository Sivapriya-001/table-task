...
//   Card,
//   Grid,
//   Typography,Paper, Table, TableBody, TableContainer, TableHead, TableRow
// } from "@mui/material";
// import React, { useEffect, useState } from "react";
// import Download from "../assets/icons/download.png";
// import { ButtonStyle, DivStyle, GridStyle, ImgStyle, PaginationButtonStyle, TableCellStyle } from "../styled/transactionStyle";
...
//     const body = data.map(item => Object.values(item).join(',') + '\n').join('');
//     return header + body;
//   }
...
//                 <Table stickyHeader aria-label="sticky table" sx={{height:"85vh"}}>
//                   <TableHead >
//                     <TableRow>
      ...
      <GridStyle>
        <Card>
          ...
          {/* <CircularProgress variant="solid" /> */}
            ...
            {loading && <CircularProgress variant="solid" style={{textAlign:"center", height:"100vh", width:"150vh"}} />}
              <TableContainer sx={{ maxHeight: 640 }}>
                <Table stickyHeader aria-label="sticky table" sx={{height:"85vh"}}>
                  <TableHead >
                    <TableRow>
